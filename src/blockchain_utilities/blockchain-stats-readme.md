# Mevacoin Blockchain Stats

Mevacoin Blockchain Stats utlity exports daily statistics for the mevacoin blockchain from creation through current state.

## Usage:

See also the utility's help option. `mevacoin-blockchain-stats --help`
...
- `mevacoin-blockchain-stats > stats-$(date +'%Y-%m-%d').csv`
- `mevacoin-blockchain-stats | save-to-database.sh`
