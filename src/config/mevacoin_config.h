...
namespace mevacoin
{
    namespace parameters
    {
        ...
        const uint64_t DIFFICULTY_TARGET = 180; // seconds (3 min)

        const uint32_t MEVACOIN_MAX_BLOCK_NUMBER = 500000000;
        // limit realistic per-block size to improve propagation
        const size_t MEVACOIN_MAX_BLOCK_BLOB_SIZE = 500000000;
        const size_t MEVACOIN_MAX_TX_SIZE = 1000000000;             // 10 MB
...
/* How to generate a premine:
        ...
        */
        ...
        const char GENESIS_COINBASE_TX_HEX[] = ""011401ff00010002018a678ed113998a91325c3723e3895851fd99e13a1212d9c87184429bac7b1f21010cf4fae9a34fcfb71d1300eeffbd459a7e56054818337da7b3267e4d7f22b1fd";
        static_assert(sizeof(GENESIS_COINBASE_TX_HEX) / sizeof(*GENESIS_COINBASE_TX_HEX) != 1, "GENESIS_COINBASE_TX_HEX must not be empty.");

        const uint64_t GENESIS_BLOCK_TIMESTAMP = 1324214400;

        const size_t MEVACOIN_REWARD_BLOCKS_WINDOW = 100;
        const size_t MEVACOIN_BLOCK_GRANTED_FULL_REWARD_ZONE = 100000; // bytes
        ...
        // V4: improve privacy by default while keeping block weight reasonable
        ...
        const uint32_t MIXIN_LIMITS_V4_HEIGHT = 800001;    // Variante 4 (allineato a UPGRADE_HEIGHT_V4)
        ...
        // Make retarget less sensitive: larger window, trim extremes, small lag
        ...
        const size_t DIFFICULTY_CUT = 3;   // remove 3 fastest and 3 slowest timestamps
        const size_t DIFFICULTY_CUT_V1 = 60;
        const size_t DIFFICULTY_CUT_V2 = 60;
        const size_t DIFFICULTY_LAG = 1;   // use a small lag to reduce immediate impact
        ...
        const uint64_t MEVACOIN_NUMBER_OF_PERIODS_TO_FORGET_TX_DELETED_FROM_POOL = 7; // periods

        const size_t FUSION_TX_MAX_SIZE = MEVACOIN_BLOCK_GRANTED_FULL_REWARD_ZONE_CURRENT * 30 / 100;
        const size_t FUSION_TX_MIN_INPUT_COUNT = 12;
        const size_t FUSION_TX_MIN_IN_OUT_COUNT_RATIO = 4;

        // Upgrade heights aligned with suggested activation schedule
