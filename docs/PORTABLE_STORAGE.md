...
Mevacoin makes use of a set of helper classes from a small library named
[epee](https://github.com/pasqualelembo78/mevacoin/tree/master/contrib/epee). Part
of this library implements a networking protocol called
[Levin](https://github.com/pasqualelembo78/mevacoin/blob/master/contrib/epee/include/net/levin_base.h),
which internally uses a storage format called [Portable
Storage](https://github.com/pasqualelembo78/mevacoin/tree/master/contrib/epee/include/storages).
This format (amongst the rest of the
[epee](https://github.com/pasqualelembo78/mevacoin/tree/master/contrib/epee)
...
```json
{
  ...
  "long_quote": "Mevacoin is more than just a technology. It's also what the technology stands for.",
...
4d 6f 6e 65 72 6f 20 69 73 20 6d 6f 72 65 20 74 // STRING value ("Mevacoin is more t")
...
#### Links to some Mevacoin struct definitions

- [Core RPC
  definitions](https://github.com/pasqualelembo78/mevacoin/blob/master/src/rpc/core_rpc_server_commands_defs.h)
- [CryptoNote protocol
  definitions](https://github.com/pasqualelembo78/mevacoin/blob/master/src/cryptonote_protocol/cryptonote_protocol_defs.h)
